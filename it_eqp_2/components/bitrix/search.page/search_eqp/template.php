...
<div class="search-page">
	<div class="search-title-eqp">Добавить связанное оборудование:</div>
	...
	<div class="search_results" >
		<?foreach($arResult["SEARCH"] as $arItem):?>
			<div class="item_search">
				<a data-id="<?echo $arItem["ITEM_ID"]?>" href="<?echo $arItem["URL"]?>"><?echo $arItem["TITLE_FORMATED"]?></a>
				...
				?>
				<button class="btn_add_composite" style="cursor:pointer;" >Добавить как дочерние </button>
				<button class="btn_add_composite_revers" style="cursor:pointer;" >Добавить как головное</button>
				<hr />
