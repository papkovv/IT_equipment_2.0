...
<div class="pagetitle-container pagetitle-align-right-container <?=$pagetitleAlignRightContainer?>">
	...
	<?if(in_array(1, $arGroups)  || in_array(29, $arGroups)):?>
		<?if($_GET['list_id'] == 85):?>
			<span  class="equip_btn" data-link="" >Переместить</span>
		<?endif;?>
	
	<span class="equip_xls_import" onclick="document.location.href=&quot;/equipment/?mode=excel&amp;amp;list_id=85?mode=view&amp;list_id=<?=$_GET['list_id']?>&amp;section_id=0&amp;list_section_id=&amp;clear_cache=Y&amp;ncc=y&quot;" class="menu-popup-item menu-popup-no-icon "><span class="menu-popup-item-text">Экспорт в Excel</span></span>
	<? if($listAction):?>
	...
	<?if($arResult["CAN_ADD_ELEMENT"] || $arResult["CAN_EDIT_SECTIONS"]):?>
		<div class="ui-btn-split ui-btn-primary">
			<a href="<?=$arResult["LIST_NEW_ELEMENT_URL"]?>&mol=&fakt=&molname=&faktname=" id="lists-title-action-add" class="ui-btn-main"><?=Loc::getMessage("CT_BLL_TOOLBAR_ADD")?></a>
